...
class FiducialDetector
{
  ...
  FiducialDetector(PApplet parent)
  {
    ...
    nya.addARMarker("data"+File.separator+"fid_4x4_15.patt", 80); //id=5
    //nya.addARMarker("data"+File.separator+"fid_4x4_16.patt", 80); //id=6
    //nya.addARMarker("data"+File.separator+"fid_4x4_17.patt", 80); //id=7
    //nya.addARMarker("data"+File.separator+"fid_4x4_18.patt", 80); //id=8
    //nya.addARMarker("data"+File.separator+"fid_4x4_19.patt", 80); //id=9
    //nya.addARMarker("data"+File.separator+"fid_4x4_20.patt", 80); //id=10
    //nya.addARMarker("data"+File.separator+"fid_4x4_21.patt", 80); //id=11
    //nya.addARMarker("data"+File.separator+"fid_4x4_22.patt", 80); //id=12
    
    data = new Fiducial[6]; // number of fiducials;
